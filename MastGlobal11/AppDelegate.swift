...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    struct storyBoardConstants{
        ...
        static var HOMESCREEN_ID = "homescreen"
        ...
        if loggedIn == true{
            ...
            if loggedIn == true{
                if let mainboard = storyBoard{
                    ...
                    let homeScreenController = mainboard.instantiateViewControllerWithIdentifier(storyBoardConstants.HOMESCREEN_ID)
...
extension AppDelegate{
    ...
    func setInitialData(){
        //coreDataAPI.insertDemoData()
        //var records = coreDataAPI.getRecord()
        //print("\(records)")
    }
}
